...
from block import Block, dict_to_block, calculate_hash, get_genesis_block
from utils import replace_chain, find_block, hash_matched_difficulty
...
def listener():
    ...
    while True:
        try:
            ...
            print("After request handled, the chain is:")
            for b in chain:
                print(b)
    ...
    while True:
        ...
        while latest_block == chain[-1]:
            ...
            if hash_matched_difficulty(hash, latest_block.difficulty):
                ...
                print("New block found: %s" % new_block)
